...
def test_load_gold_resolves_cited_abstracts_and_labels(tmp_path):
    ...
    _write_jsonl(
        claims,
        [
            {"id": 10, "claim": "Claim one.", "evidence": {"1": [{"sentences": [0], "label": "SUPPORT"}]}, "cited_doc_ids": [1]},
            {"id": 11, "claim": "Claim two.", "evidence": {"2": [{"sentences": [0], "label": "CONTRADICT"}]}, "cited_doc_ids": [2]},
